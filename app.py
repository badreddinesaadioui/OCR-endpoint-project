...
# ---------------------------------------------------------------------------
def _cache_dir():
    d = os.path.join(os.path.dirname(os.path.abspath(__file__)), "ocr_cache")
...
if analyze and openai_key and mistral_key:
    ...
    st.caption("Add OPENAI_API_KEY and MISTRAL_API_KEY to `.streamlit/secrets.toml`, then upload a PDF and paste ground truth text.")
